...
output "_03_sql_instance_connection_name" {
  value = google_sql_database_instance.private_sql_instance.connection_name
}

output "_04_initiate_sql_listner_connection" {
  ...
  output "_05_retrieve_db_username" {
 ...
 output "_06_retrieve_db_password" {
